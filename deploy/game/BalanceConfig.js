...
export const TIER_COST_MULTIPLIER = {
    [Tier.T1]: 1,
    [Tier.T2]: 100,
    [Tier.T3]: 10000,
    [Tier.T4]: 1000000,
...
export const TIER_EFFICIENCY_MULTIPLIER = {
    [Tier.T1]: 1,
    [Tier.T2]: 10,
    [Tier.T3]: 100,
    [Tier.T4]: 1000,
...
(function (StructureType) {
    ...
    StructureType["Insulator"] = "insulator";
    StructureType["Turbine"] = "turbine";
    StructureType["Substation"] = "substation";
    StructureType["VoidCell"] = "void_cell";
 ...
 */
export const STRUCTURE_BASE_STATS = {
    [StructureType.Empty]: {
        name: 'Empty',
        baseCost: 0,
        meltTemp: Infinity,
...
(function (UpgradeType) {
    ...
    UpgradeType["FuelLifetime"] = "fuel_lifetime";
    UpgradeType["FuelHeatOutput"] = "fuel_heat_output";
    // Structure upgrades
    UpgradeType["TurbineConductivity"] = "turbine_conductivity";
    UpgradeType["InsulatorConductivity"] = "insulator_conductivity";
    UpgradeType["SubstationSaleRate"] = "substation_sale_rate";
    UpgradeType["VentilatorDissipation"] = "ventilator_dissipation";
    // Global upgrades
    UpgradeType["TickSpeed"] = "tick_speed";
    UpgradeType["ManualClickPower"] = "manual_click_power";
    // Melt temperature upgrades (one per structure type)
    UpgradeType["MeltTempFuelRod"] = "melt_temp_fuel_rod";
    UpgradeType["MeltTempVentilator"] = "melt_temp_ventilator";
    UpgradeType["MeltTempHeatExchanger"] = "melt_temp_heat_exchanger";
    UpgradeType["MeltTempInsulator"] = "melt_temp_insulator";
    UpgradeType["MeltTempTurbine"] = "melt_temp_turbine";
    UpgradeType["MeltTempSubstation"] = "melt_temp_substation";
...
// SECRET UPGRADES
// =============================================================================
export var SecretUpgradeType;
(function (SecretUpgradeType) {
    SecretUpgradeType["ExoticFuel"] = "exotic_fuel";
    SecretUpgradeType["ReactorExpansion1"] = "reactor_expansion_1";
    SecretUpgradeType["ReactorExpansion2"] = "reactor_expansion_2";
    SecretUpgradeType["ReactorExpansion3"] = "reactor_expansion_3";
    SecretUpgradeType["ReactorExpansion4"] = "reactor_expansion_4";
    SecretUpgradeType["VoidCellUnlock"] = "void_cell_unlock";
    SecretUpgradeType["Overclock"] = "overclock";
    SecretUpgradeType["Salvage"] = "salvage";
})(SecretUpgradeType || (SecretUpgradeType = {}));
export const SECRET_UPGRADE_DEFINITIONS = {
...
export const SECRET_UNLOCK_CONDITIONS = {
    [SecretUpgradeType.ExoticFuel]: {
        type: 'meltdown',
    ...
    [SecretUpgradeType.Overclock]: {
        type: 'total_earned',
        threshold: 10000, // 10,000 total money earned
    },
    [SecretUpgradeType.Salvage]: {
        type: 'demolish_count',
 ...
 */
export function getStructureCost(type, tier) {
 ...
 */
export function getFuelLifetime(tier, upgradeLevel) {
 ...
 */
export function getFuelHeatGeneration(tier, upgradeLevel) {
    const baseStats = STRUCTURE_BASE_STATS[StructureType.FuelRod];
 ...
 */
export function getSecretUnlockProgress(upgradeType, gameStats) {
